        ...
        <div className="w-full max-w-lg space-y-6">
          <div className="max-w-sm bg-card border border-app rounded-lg shadow-sm">
            <div className="p-5">
              ...
              <p className="text-base text-muted">Inicie sesión para continuar</p>
              {error && (
              ...
              <FormProvider {...methods}>
                <form className="flex flex-col gap-4 mt-4" onSubmit={onSubmit} noValidate>
                  <FormInput label="Email" name="email" placeholder="Escriba su email" />
                  <FormInput
                    label="Contraseña"
                    name="password"
                    type="password"
